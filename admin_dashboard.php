...
<body>
    <center><img id="mimg" src="images/KIbabii-Logo.png" class="img-responsive" style="width: 100px;" /></center>
   <!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="register.php">Add students</a></li>
  ...
  <div class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="#section2">New Applications</a></li>
        <li><a href="#section3">Approved Applications</a></li>
        <li><a href="#section3">Rejected Applications</a></li>
      </ul><br>
    </div>
    <br>
