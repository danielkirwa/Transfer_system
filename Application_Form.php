...
$Current_Program = $_POST["Current_Program"];
$Program_Applied_For = $_POST["Program_Applied_For"];
$KCSE_Index_No = $_POST["KCSE_Index_No"];
$KCPE_Index_No = $_POST["KCPE_Index_No"];
...
$sql = "INSERT INTO tblstuddetails (Details_Id, Name, Reg_No, Phone_No, Current_Program, Program_Applying_For, KCSE_Index_No, KCPE_Index_No, Uploads, Mat, Eng, Kis, Chem, Bio, Phy, Geog, CRE, Histrory, Agric, Bus, French, Music, Home_Sci, Computer_Studies, Student_Id) VALUES ('$Details_Id, $Name, $Reg_No, $Phone_No, $Current_Program, $Program_Applying_For, $KCSE_Index_No, $KCPE_Index_No, $Uploads, $Mat, $Eng, $Kis, $Chem, $Bio, $Phy, $Geog, $CRE, $Histrory, $Agric, $Bus, $French, $Music, $Home_Sci, $Computer_Studies, $Student_Id')";
