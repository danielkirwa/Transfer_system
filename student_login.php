...
<center><h1 class="text-center ">Kibabii University Faculty Transfer System<br /><small style="font-size:20px">Knowledge For Development</small></h1>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="/action_page.php" method="post">
    <div class="imgcontainer">
      ...
      <img src="images/KIbabii-Logo.png" alt="Avatar" class="avatar" style="width: 50px">
    </div>
